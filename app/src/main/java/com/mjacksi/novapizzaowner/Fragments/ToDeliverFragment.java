 ...
 */
public class ToDeliverFragment extends Fragment {
    final String FRAGMENT_TYPE = OrdersAdapter.TO_DELIVER;
    final String NEXT_FRAGMENT_TYPE = OrdersAdapter.DELIVERED;

    OrdersAdapter adapter;
    FirebaseDatabase firebaseDatabase;

    public ToDeliverFragment() {
